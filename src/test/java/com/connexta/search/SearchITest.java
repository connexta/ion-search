...
class SearchITest {
  ...
  //            .setBody(
  //                String.format(
  //                    "{ \"%s\" : \"All the color had been leached from %s until only grey and
  // white remained.\" }",
  ...
  //                    .setParameter("q", String.format("%s LIKE '%s'", CONTENTS_ATTRIBUTE,
  // keyword))
  //                    .build()
  //                    .toString()))
  //        .exchange()
  ...
  //    assertThat(firstGetIrmRequest.getPath(), is(String.format("/dataset/%s/irm",
  // firstDatasetId)));
  //
  //    // when index
  //    final String keyword = "Winterfell";
  ...
  //        new MockResponse()
  //            .setBody(
  //                String.format("{\"%s\":\"first IRM metadata %s\"}", EXT_EXTRACTED_TEXT,
  // keyword))
  //            .setResponseCode(200));
  //    final String firstDatasetId = "000b27ffc35d46d9ba041f663d9ccaff";
  //    final URI firstIrmUri =
  ...
  //        new MockResponse()
  //            .setBody(
  //                String.format("{\"%s\":\"second IRM metadata %s\"}", EXT_EXTRACTED_TEXT,
  // keyword))
  //            .setResponseCode(200));
  //    final String secondDatasetId = "001ccb7241284f21a3d15cc340c6aa9c";
  //    final URI secondIrmUri =
  ...
  //                new URIBuilder()
  //                    .setPath(QueryController.URL_TEMPLATE)
  //                    .setParameter("q", CONTENTS_ATTRIBUTE + " LIKE 'this doesn''t match any
  // IRM'")
  //                    .build()
  //                    .toString()))
  //        .exchange()
